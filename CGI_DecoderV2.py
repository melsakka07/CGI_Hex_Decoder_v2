...
# Add title
ttk.Label(root, text="CGI Decoder HEX to DEC", font=("Helvetica", 16)).grid(row=0, column=0, columnspan=2, pady=10)
...
decode_button.grid(row=4, column=0, pady=10)
...
# Add note
ttk.Label(root, text="Created by M. ElSakka - 2024, All Rights Reserved ©️", font=("Helvetica", 8)).grid(row=7, column=0, columnspan=2, pady=10)
